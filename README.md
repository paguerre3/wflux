...
- ***Note about Database Creation***: By default, if Database isn't created but User has right privileges, <b>Database will be created automatically in the 1st Save of a Document</b>. 
...
```
```text
// output console (more than a 100 elements are ignored on each iteration):
Element kept by consumer: 0
Element kept by consumer: 123
Element kept by consumer: 245
Element kept by consumer: 368
Element kept by consumer: 492
Element kept by consumer: 601
Element kept by consumer: 726
Element kept by consumer: 851
Element kept by consumer: 968
Element kept by consumer: to N
```
    ...
    private Flux<Long> createOverflowFluxWithBufferingOnBackpressure() {
        ...
        return Flux.interval(Duration.ofMillis(1))
                ...
                .onBackpressureBuffer(1500,
                        // When the buffer is full, remove the oldest element from it and "offer the new element at the end instead", i.e. LATEST.
...
Element kept by consumer: 145
Element kept by consumer: 255
Element kept by consumer: 371
Element kept by consumer: 480
Element kept by consumer: to N
```
